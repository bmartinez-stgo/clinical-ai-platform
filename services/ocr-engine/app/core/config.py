...
@dataclass
class Settings:
    app_name: str = os.getenv("APP_NAME", "ocr-engine")
    app_namespace: str = os.getenv("APP_NAMESPACE", "cap-prod-ocr-engine")
    ...
    engine_id: str = os.getenv("ENGINE_ID", "zai-org/GLM-OCR")
